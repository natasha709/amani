...
// Deduplicate list, but wait, usually we want some sort of canonical ones.
// In the array above we just list them. We can remove exact dupes if preferred or show them as is.
